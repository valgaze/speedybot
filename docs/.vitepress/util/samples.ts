 ...
 */
export const samples: { label: string; value: string; name: string }[] = [
  {
...
const card = Bot.card()
  ...
  },
  {
    ...
    name: "appcard",
    value: `const Bot = new SpeedyBot();
const card = Bot.appCard('Design News', 'https://raw.githubusercontent.com/valgaze/speedybot-mini/deploy/docs/assets/figma_logo.png')
...
/*
  - Full docs: https://speedybot.js.org/api-docs/classes/SpeedyCard
...
export const getRandomElement = (list: unknown[]) => {
  ...
  const res = list[randomIndex];
  return res;
};
export const getRandomSpeedyCard = () => getRandomElement(samples) + footer;
